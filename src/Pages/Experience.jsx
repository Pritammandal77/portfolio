    ...
    return (
        <>
            <div className='md:hidden w-full h-auto flex flex-col items-center py-10 xl:py-20'>
                ...
                <div className='w-full flex items-center justify-center py-5 pl-5'>
                    <ol className="relative border-s border-gray-200 dark:border-gray-700 w-[98vw] xl:w-[70%]">
                        <MotionWrapper direction='-x' >
                            <li className="mb-10 ms-6 pl-6 xl:p-8">
                                ...
                                <div className='flex flex-col gap-5 text-[17px] border-2 border-[#1a1a1a] rounded-xl p-3 relative right-2'>
                                    <div>
