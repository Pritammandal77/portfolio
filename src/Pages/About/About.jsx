            ...
            <div className=' flex flex-col md:flex-row gap-5 md:gap-0 xl:gap-5 lg::h-[75vh] '>
                ...
                /> */}
                    <div className="bg-[#181818] w-[100%] p-[15px] rounded-[15px] border-2 border-[#2e2e2e] flex flex-col gap-[10px]">
                        ...
                        <p className="text-[16px] md:text-[18px] text-justify">
                            Worked as a Full Stack Developer Intern at GharPadharo. I contributed to the development of their Careers Website, handling both frontend and backend tasks.
                        </p>
                ...
                <div className="w-[100vw]  md:w-[48vw] xl:w-[43vw] h-auto px-2 flex flex-col gap-5 ">
                    <div className="bg-[#181818] w-[100%] p-[15px] rounded-[15px] border-2 border-[#2e2e2e] flex flex-col gap-[10px]">
                        ...
                        <p className="text-[16px] md:text-[18px] text-justify">
                            I'm Pritam Mandal, a passionate Full Stack Developer who enjoys bringing ideas to life through fast, functional, and visually appealing web applications.
                        </p>

                        <p className="text-[16px] md:text-[18px] text-justify">
                            I love working across the entire web stack — crafting clean and responsive UIs with <span className="text-[#a75dd6] font-semibold">React.js</span>, and building secure, scalable backend systems using <span className="text-[#a75dd6] font-semibold">Node.js</span>, <span className="text-[#a75dd6] font-semibold">Express</span>, and <span className="text-[#a75dd6] font-semibold">MongoDB</span>.
                        </p>

                        <p className="text-[16px] md:text-[18px] text-justify">
                            I thrive in building real-world projects, solving problems through code, and continuously learning to stay updated with the ever-evolving tech landscape.
                        </p>
                    </div>
