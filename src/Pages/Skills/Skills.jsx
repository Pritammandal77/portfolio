...
//   return (
//     <>
//       <div className='skillsContainer overflow-x-hidden'>
...
function Skills() {
  ...
  return (
    ...
    <div className='w-full h-auto overflow-x-hidden flex flex-col gap-10 items-center justify-evenly px-4 py-[50px] lg:px-[100px] relative mt-0 md:mt-[50px]'>
      <h1 className="text-[35px] lg:text-[50px] font-semibold text-center mb-[60px] text-[#e7e7e7]">Skills & technologies</h1>
