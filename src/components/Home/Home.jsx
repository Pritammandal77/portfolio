        ...
        <>
            <div className="mainBodyContainer">
                <div className="bodyContainer1">
                    <div>
                        <h1 ref={helloRef} className="hello">Hello , It's Me</h1>
                        <h1 className="myName" ref={nameRef}>Pritam Mandal</h1>
                        <div ref={positionRef} className="positionDiv">
                            <h1 className='IamA'> I am a </h1>
                            <h1 className="myRole"><pre> {displayedText}<span className="cursor">|</span></pre></h1>
                        </div>
                    </div>
                    <div className="social-buttons" ref={iconsRef}>
                ...
                <div className="bodyContainer2">
                    <img src="portfolio2.jpeg.jpg" alt="Sorry The Image is Not Available"
