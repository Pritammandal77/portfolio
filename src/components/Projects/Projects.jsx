    ...
    return (
        <>
            <div className="projectsPage">
                ...
                <div className="card" ref={project1}>
                        ...
                        <h2>Recipe Gram</h2>
                        <p>It is a recipe App , You Can Search Any Recipes , View The
                            Full Recipe , Its Ingredients
                            Also You can save Your Favourite Recipes , Delete Recipes .
                        </p>
                    ...
                    <div className="card" ref={project2}>
                        ...
                        <h2>Aura AI</h2>
                        <p>It Is A smart and interactive chatbot designed to provide
                            quick, accurate, and engaging responses to users.
                        </p>
                        <button className="liveViewBtn submitButton">
                            <a href="https://the-aura-ai.netlify.app/" className="linkText"
                                target="_blank">view</a>
                        </button>
                    </div>
                    ...
                    <div className="card" ref={project4}>
