...
import { Copy, Check, Minimize, Scan, X } from "lucide-react";
    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 cursor-pointer bg-purple-600 hover:bg-purple-700 text-white px-5 py-3 rounded-full shadow-xl transition z-50"
            >
                Chat with PAI
            </button>
...
//             {
//                 open && (
//                     <div className="fixed top-0 right-0 md:top-auto md:bottom-24 md:right-6 md:px-0 w-full h-[100vh] md:w-[360px] md:h-[500px] xl:w-[400px] bg-[#0f0f0f] md:rounded-2xl shadow-2xl flex flex-col overflow-hidden z-[100]"
//                         onWheel={(e) => e.stopPropagation()}
//                     >
